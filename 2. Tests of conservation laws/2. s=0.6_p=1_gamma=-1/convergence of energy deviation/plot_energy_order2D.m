...
% step decreases for equation parameters (s,p,gamma) = (0.6,1,-1).

clear
load('energy_order_(0.6,1,-1).mat');
...
loglog(Dt,10^-1.2*Dt.^4, '--','Color',[0.3,0.3,0.3],'LineWidth',2);
...
set(gca,'yTick',10.^(-11:1:-4));
set(gca,'TickLabelInterpreter','tex');
axis([2^-6.8,2^-3.8,10^-10,10^-5])

% Legend
h_legend = legend('initial data 1','initial data 2','$10^{-1.2}\tau^4$','Interpreter', 'latex');

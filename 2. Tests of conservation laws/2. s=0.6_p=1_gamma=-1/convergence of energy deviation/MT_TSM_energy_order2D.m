...
% (0.6,1,-1) and initial data 1 and 2, using BioMT+TSM4.
...
loglog(Dt,10^-1.2*Dt.^4,'--')
xlabel dt, ylabel |E(T)-E(0)|/E(0)

%% Save the necessary data for the deviation of discrete energy
save("energy_order_(0.6,1,-1).mat","energy_drift_1","energy_drift_2","s","p","gamma","N","mu","T","Dt");
...
% 
% 1. parameters: (s,p,gamma) = (0.6,1,1).
...
mu = 0.5/sqrt(N); % the scaling factor for MT-functions, change {MT(m,x)*MT(n,y)} to {MT(m,mu*x)*MT(n,mu*y)}
...
save("simulation2D_diffusion_s=0.6.mat","s","p","gamma","N","mu","dt","T","unum_node","Tstep","inter","opt_Sign_SignM","opt_iTheta");
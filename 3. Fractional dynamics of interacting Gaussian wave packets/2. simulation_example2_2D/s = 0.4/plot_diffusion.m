% This program uses the data computed by equation2D_diffusion.m to plot the
% corresponding numerical evolution process.

clear, close all;
load('simulation2D_diffusion_s=0.4.mat');

%% Compute the values of numerical solution ​​at plotting points
M = 22.5; % plotting area [-M,M]^2
pt = -M:M/2250:M; [pt2,pt1] = meshgrid(pt); % plotting points [pt1,pt2]
...
for m = 1:inter+1
    ...
    set(gca,'FontSize',14); set(gca,'yTick',-20:10:20); % yTick

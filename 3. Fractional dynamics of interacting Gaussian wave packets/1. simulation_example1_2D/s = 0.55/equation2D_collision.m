...
% 
% 1. parameters: (s,p,gamma) = (0.55,1,1).
...
s = 0.55; p = 1; gamma = 1; % equation parameter
...
save("simulation2D_collision_s=0.55.mat","s","p","gamma","N","mu","dt","T","unum_node","Tstep","inter","opt_Sign_SignM","opt_iTheta");
...
% 3. truncation "N".
% 4. common matrix "BioMTmatrix".
% 5. opt-matrix "opt_Sign_SignM", "opt_iTheta" and "opt_expm_w".
% output: the values of \psi(x,y,dt) on MT-nodes "Psi".
%
% This function has been optimized for efficiency. See
% MT_TSM_equation2D_bo.m for details on "BioMTmatrix", "opt_Sign_SignM",
% "opt_iTheta" and "opt_expm_w".

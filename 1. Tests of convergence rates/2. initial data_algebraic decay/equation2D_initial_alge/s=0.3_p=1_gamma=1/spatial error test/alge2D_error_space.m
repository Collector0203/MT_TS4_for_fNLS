...
% program solves this equation with parameters (s,p,gamma) = (0.3,1,1) and
% initial value function \psi_0(x,y) = 1/(1+x^2+y^2)^(1/2+sqrt(2)) by
...
Mu = 1./sqrt(NNN); % the scaling factor for MT-functions, change {MT(m,x)*MT(n,y)} to {MT(m,mu*x)*MT(n,mu*y)}

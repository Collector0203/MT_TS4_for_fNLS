...
loglog(Line,10^(0.35)*Line.^(-4.06),'r--','LineWidth',2), hold on
loglog(Line,10^(1.05)*Line.^(-6.29),'b--','LineWidth',2)
...
axis([2^2,2^6,10^-10.3,10^0.3])

% Legend
h_legend = legend('$L^2$-error','$L^\infty$-error','$\propto N^{-4.06}$', ...
    '$\propto N^{-6.29}$','Interpreter', 'latex');
